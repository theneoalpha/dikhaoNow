      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <SearchBar 
                placeholder="Search for tiles, marble, furniture, carpenters..."
            ...
            >
              <Button
                ...
                className="group bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] hover:from-[var(--accent)] hover:to-[var(--primary)]"
              >
                {ctaText}
                ...
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 rounded-3xl p-8 shadow-2xl">
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl p-4 border border-white/10">
                      ...
                      <div className="text-white text-sm font-medium">Digital Catalogs</div>
                    </div>
                    <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl p-4 border border-white/10">
                      <Users className="w-8 h-8 text-blue-400 mb-2" />
                      <div className="text-white text-sm font-medium">Local Businesses</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <div className="text-white font-medium text-sm">Raj Tiles & Marble</div>
                        <div className="text-white/60 text-xs">Tiles Dealer • Mumbai</div>
                      </div>
                    </div>
